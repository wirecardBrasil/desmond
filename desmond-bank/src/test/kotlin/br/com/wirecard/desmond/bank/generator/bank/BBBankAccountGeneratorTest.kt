...
class BBBankAccountGeneratorTest {
    @Test
    fun shouldGenerateCorrectCheckDigits() {
        ...
        val bankAccount = BankAccount(Bank.BancoDoBrasil, validAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAgencyLengthIsIncorrect() {
        ...
        val validAccountNumber = objectFactory.VALID_ACCOUNT_NUMBER
        val bankAccount = BankAccount(Bank.BancoDoBrasil, invalidAgencyNumber, validAccountNumber)
