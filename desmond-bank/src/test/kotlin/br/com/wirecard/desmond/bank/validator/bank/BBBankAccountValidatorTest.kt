...
class BBBankAccountValidatorTest {
    @Test
    fun shouldBeTrueForValidAgencyAndAccount() {
        ...
        val bankAccount = BankAccount(Bank.BancoDoBrasil, validAgencyNumber, validCheckDigit, validAccountNumber, validCheckDigit)
    ...
    fun shouldThrowCorrectExceptionForInvalidAgencyCheckDigit() {
        ...
        val bankAccount = BankAccount(Bank.BancoDoBrasil, validAgencyNumber, invalidAgencyCheckDigit, validAccountNumber, validAccountCheckDigit)
    ...
    fun shouldThrowCorrectExceptionForInvalidAccountCheckDigit() {
        ...
        val bankAccount = BankAccount(Bank.BancoDoBrasil, validAgencyNumber, validAgencyCheckDigit, validAccountNumber, invalidAccountCheckDigit)
        validator.validate(bankAccount)
    }
