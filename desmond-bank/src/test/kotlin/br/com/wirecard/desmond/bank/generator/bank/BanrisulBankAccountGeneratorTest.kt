...
class BanrisulBankAccountGeneratorTest {
    @Test
    fun shouldGenerateCorrectCheckDigits() {
        ...
        val bankAccount = BankAccount(Bank.Banrisul, validAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAgencyLengthIsIncorrect() {
        ...
        val validAccountNumber = objectFactory.VALID_ACCOUNT_NUMBER
        val bankAccount = BankAccount(Bank.Banrisul, invalidAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAccountLengthIsIncorrect() {
        ...
        val bankAccount = BankAccount(Bank.Banrisul, validAgencyNumber, invalidAccountNumber)
        generator.generate(bankAccount)
    }
