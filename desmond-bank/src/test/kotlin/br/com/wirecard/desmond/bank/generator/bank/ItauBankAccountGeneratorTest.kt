...
import br.com.wirecard.desmond.bank.factory.ItauObjectFactory as objectFactory
import br.com.wirecard.desmond.bank.generator.bank.ItauBankAccountGenerator as generator

class ItauBankAccountGeneratorTest {
    @Test
    fun shouldGenerateCorrectCheckDigits() {
        ...
        val bankAccount = BankAccount(Bank.Itau, validAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAgencyLengthIsIncorrect() {
        ...
        val validAccountNumber = objectFactory.VALID_ACCOUNT_NUMBER
        val bankAccount = BankAccount(Bank.Itau, invalidAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAccountLengthIsIncorrect() {
        ...
        val bankAccount = BankAccount(Bank.Itau, validAgencyNumber, invalidAccountNumber)
        generator.generate(bankAccount)
    }
