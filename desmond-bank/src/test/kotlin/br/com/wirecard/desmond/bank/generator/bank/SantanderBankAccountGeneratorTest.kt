...
class SantanderBankAccountGeneratorTest {
    @Test
    fun shouldGenerateCorrectCheckDigits() {
        ...
        val bankAccount = BankAccount(Bank.Santander, validAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAgencyLengthIsIncorrect() {
        ...
        val validAccountNumber = objectFactory.VALID_ACCOUNT_NUMBER
        val bankAccount = BankAccount(Bank.Santander, invalidAgencyNumber, validAccountNumber)
    ...
    fun shouldThrowCorrectExceptionWhenAccountLengthIsIncorrect() {
        ...
        val bankAccount = BankAccount(Bank.Santander, validAgencyNumber, invalidAccountNumber)
        generator.generate(bankAccount)
    }
